...
class SourcesController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Source $source) // когда мы делаем запрос мы передаем ид лида который нужно удалить и Laravel автоматически подставляет его сюда в $source
    {
        //
        $source->delete();
        return ResponseServise::sendJsonResponse(true, 200,[],[
