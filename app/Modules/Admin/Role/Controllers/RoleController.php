...
class RoleController extends Base
{
    ...
    {
        $this->authorize('view', Role::class); // $this->authorize() проверяет что вернет правила с методом('view') для сущности\модели(Role::class); Это мы указали в RolePolicy
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(RoleRequest $request) // в RoleRequest содержится правила валидации данных
    {
